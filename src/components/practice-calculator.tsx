...
import { TrendingUp, DollarSign, Users, PieChart, Building2, User, Calendar, Save } from 'lucide-react'
...
export function PracticeCalculator({
  ...
  }, [revenue, patients, newPatients, avgVisits, marketingCosts, directCareCosts, overheadCosts])
  ...
  const hasInputs = revenue > 0 || patients > 0 || newPatients > 0 || avgVisits > 0 || marketingCosts > 0 || directCareCosts > 0 || overheadCosts > 0

  // Check if all required fields are filled (for showing save button)
  const allFieldsFilled = revenue > 0 && patients > 0 && newPatients > 0 && avgVisits > 0 && marketingCosts >= 0 && directCareCosts >= 0 && overheadCosts >= 0
    ...
    <div className="w-full max-w-7xl mx-auto">
      ...
      <Card className="mb-8 border-2 border-gray-200 shadow-lg">
        <CardHeader className="bg-gradient-to-r from-teal-50 to-blue-50">
          <CardTitle className="text-2xl text-gray-900">Enter your practice's yearly data</CardTitle>
        </CardHeader>
        <CardContent className="pt-6">
          <div className="grid md:grid-cols-2 gap-6">
            <div className="space-y-2">
              <Label htmlFor="revenue" className="text-base font-semibold text-gray-700">
              ...
              <div className="relative">
                ...
                <Input
                  id="revenue"
                  type="text"
                  value={revenue ? formatNumberWithCommas(revenue.toString()) : ''}
            ...
            <div className="space-y-2">
              <Label htmlFor="patients" className="text-base font-semibold text-gray-700">
              ...
              <div className="relative">
                ...
                <Input
                  id="patients"
                  type="text"
                  value={patients ? formatNumberWithCommas(patients.toString()) : ''}
                  onChange={(e) => handleNumberInput(e.target.value, setPatients)}
                  placeholder="1,000"
                  className="pl-10 h-12 text-lg border-2 focus:border-teal-500"
                />
              </div>
            ...
            <div className="space-y-2">
              <Label htmlFor="newPatients" className="text-base font-semibold text-gray-700">
              ...
              <div className="relative">
                ...
                <Input
                  id="newPatients"
                  type="text"
                  value={newPatients ? formatNumberWithCommas(newPatients.toString()) : ''}
                  onChange={(e) => handleNumberInput(e.target.value, setNewPatients)}
                  placeholder="200"
                  className="pl-10 h-12 text-lg border-2 focus:border-teal-500"
                />
              </div>
            ...
            <div className="space-y-2">
              <Label htmlFor="marketing" className="text-base font-semibold text-gray-700">
              ...
              <div className="relative">
                ...
                <Input
                  id="marketing"
                  type="text"
                  value={marketingCosts ? formatNumberWithCommas(marketingCosts.toString()) : ''}
                  onChange={(e) => handleNumberInput(e.target.value, setMarketingCosts)}
                  placeholder="50,000"
                  className="pl-10 h-12 text-lg border-2 focus:border-teal-500"
                />
              </div>
            ...
            <div className="space-y-2">
              <Label htmlFor="directCare" className="text-base font-semibold text-gray-700">
              ...
              <div className="relative">
                ...
                <Input
                  id="directCare"
                  type="text"
                  value={directCareCosts ? formatNumberWithCommas(directCareCosts.toString()) : ''}
                  onChange={(e) => handleNumberInput(e.target.value, setDirectCareCosts)}
                  placeholder="200,000"
                  className="pl-10 h-12 text-lg border-2 focus:border-teal-500"
                />
              </div>
            ...
            <div className="space-y-2">
              <Label htmlFor="overhead" className="text-base font-semibold text-gray-700">
              ...
              <div className="relative">
                ...
                <Input
                  id="overhead"
                  type="text"
                  value={overheadCosts ? formatNumberWithCommas(overheadCosts.toString()) : ''}
            ...
            <div className="space-y-2">
              <Label htmlFor="avgVisits" className="text-base font-semibold text-gray-700">
      ...
      {hasInputs && (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
          <h3 className="text-3xl font-bold text-gray-900">Your Practice Metrics</h3>

          {/* Practice Overview */}
          <div>
            <div className="flex items-center gap-2 mb-4">
              <Building2 className="w-6 h-6 text-teal-600" />
              <h4 className="text-2xl font-semibold text-gray-800">Practice Overview</h4>
            </div>
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <h4 className="text-2xl font-semibold text-gray-800">Patient Overview</h4>
            </div>
            <div className="grid md:grid-cols-2 gap-6">
              {/* Profit per Patient */}
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <h4 className="text-2xl font-semibold text-gray-800">Visit Overview</h4>
            </div>
            <div className="grid md:grid-cols-2 gap-6">
              {/* Profit per Visit */}
          ...
          <Card className="border-2 border-gray-200 shadow-lg mt-8 animate-in fade-in slide-in-from-bottom-4 delay-700">
            <CardHeader className="bg-gradient-to-r from-gray-50 to-gray-100">
              <CardTitle className="text-2xl text-gray-900">Financial Breakdown</CardTitle>
            </CardHeader>
            <CardContent className="pt-6">
              <div className="space-y-6">
                ...
                <div>
                  <div className="flex justify-between items-center mb-2">
                    <span className="text-sm font-semibold text-gray-700">Revenue Distribution</span>
                ...
                <div>
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <span className="text-sm font-semibold text-gray-900">
                      {formatCurrency(marketingCosts + directCareCosts + overheadCosts)}
                    </span>
                  </div>
      ...
      <Dialog open={showSaveModal} onOpenChange={setShowSaveModal}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Enter your information below, and we'll generate a private link for you to access this report at any time.
            </DialogDescription>
          </DialogHeader>
