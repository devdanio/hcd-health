...
function RouteComponent() {
  ...
  const updateMutation = useMutation({
    ...
    onSuccess: async () => {
      ...
      await queryClient.invalidateQueries({
        queryKey: ["org", orgId, "spend-time-series"],
      })
    },
  })
  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        <div className="text-label text-muted-foreground">Campaign Settings</div>
              ...
              <TableBody>
                {(data?.campaigns ?? []).map((c) => (
                  <TableRow key={`${c.platform}:${c.campaign_id}`}>
                    ...
                    <TableCell>{formatCents(c.last_7d_spend_cents)}</TableCell>
                    <TableCell>
                      <Select
                        ...
                        onValueChange={(value) =>
                          updateMutation.mutate({
                            ...
                            location_id: value === "unassigned" ? null : value,
                          ...
                          updateMutation.mutate({
                            ...
                            campaign_category:
                              (value as
                                ...
                                | "none") === "none"
                                ? null
                                : (value as "branded" | "non_branded" | "other"),
                          })
                        }
                      >
                        <SelectTrigger>
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value="non_branded">non_branded</SelectItem>
